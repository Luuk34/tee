...
namespace Tee_namespace
{
	class Tee
	{
		...
		public static int ShowHelp( params string[] errmsg )
		{
			...
			Note:   This program requires .NET 6

			Written by Rob van der Woude
			Compiled for .NET 6 by Luuk
			*/
			...
			Console.Error.WriteLine( "Note:   This program requires .NET 6" );

			Console.Error.WriteLine( );

			Console.Error.WriteLine( "Written by Rob van der Woude" );

			Console.Error.WriteLine( "Compiled for .NET 6 by Luuk" );
